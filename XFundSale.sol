...
contract XFundSale is Ownable {
    using SafeMath for uint256;

    IERC20 public token;
    uint256 public privateSaleStartTimestamp;
    uint256 public privateSaleEndTimestamp;
    uint256 public totalDepositedXDCBalance;
    uint256 public minimumDepositXDCAmount = uint256(2000 ether);
    uint256 public maximumDepositXDCAmount = uint256(20000 ether);
    uint256 public price = 100;


    constructor() public {
        token = IERC20(0x14DE3897E42c821e8F827086A5b4C43915a7c636);
    }
    ...
    function buy() public payable {
        ...
        require(take>= minimumDepositXDCAmount && take <= maximumDepositXDCAmount , "Wrong buy value");
        ...
        totalDepositedXDCBalance = totalDepositedXDCBalance.add(take);
    ...
    function getDepositAmount() public view returns (uint256) {
        return totalDepositedXDCBalance;
    }
    ...
    function setMinDepositAmount(uint256 newValue) external onlyOwner {
        require(newValue < maximumDepositXDCAmount, "Min value should be less than max value");
        emit UpdateMinDepositAmount(minimumDepositXDCAmount, newValue);
        minimumDepositXDCAmount = newValue;
    }

    function setMaxDepositAmount(uint256 newValue) external onlyOwner {
        require(newValue > minimumDepositXDCAmount, "Max value should be greater than min value");
        emit UpdateMinDepositAmount(maximumDepositXDCAmount, newValue);
        maximumDepositXDCAmount = newValue;
    }
